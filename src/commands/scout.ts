/**
 * grimoire scout - Spawn lightweight exploration agents for parallel cognition
 *
 ...
 *
 * Usage:
 *   grim scout <name> "<question>"     Spawn a scout
 *   grim scout list                    List all scouts
 *   grim scout show <name>             Show scout findings
 *   grim scout cancel <name>           Cancel a running scout
 *   grim scout clear                   Clear completed scouts
 */
 ...
 */
const printUsage = () => {
  console.log("Usage: grimoire scout <command> [options]");
  console.log();
  console.log("Spawn lightweight exploration agents for parallel cognition.");
  console.log();
  ...
  console.log('  grim scout auth "How does authentication work?"');
  console.log('  grim scout api --depth deep "Map all API endpoints"');
  console.log("  grim scout list");
  console.log("  grim scout show auth");
  console.log("  grim scout cancel auth");
};
...
const listScouts = (projectPath: string) =>
  Effect.gen(function* () {
    ...
    if (scouts.length === 0) {
      ...
      console.log();
      console.log('Start one with: grim scout <name> "<question>"');
      return;
    }
...
const spawnScout = (
  ...
  Effect.gen(function* () {
    ...
    console.log(`Results: grim scout show ${name}`);
  });
  ...
  Effect.gen(function* () {
    ...
    switch (subcommand) {
      ...
      case "show": {
        ...
        if (!name) {
          console.log("Usage: grim scout show <name>");
          return;
        }
      ...
      case "cancel": {
        const name = args.positional[1];
        if (!name) {
          console.log("Usage: grim scout cancel <name>");
          return;
        }
      ...
      default: {
        ...
        if (!question) {
          console.log("Usage: grim scout <name> \"<question>\"");
          console.log();
          console.log("Example: grim scout auth \"How does authentication work?\"");
          return;
        }
